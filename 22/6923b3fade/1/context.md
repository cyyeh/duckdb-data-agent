...
crate new test scenratios about skills in e2e

### Prompt 19

does clear chat history make agent really forget previous messages? please check the source code

### Prompt 20

revert sidecar deleted skill file

### Prompt 21

put skills files in skills folder in root directory and change relevant env vars
