...
why anthropic-version is 2023-06-01

### Prompt 24

fix these error messages:

INFO:     127.0.0.1:65417 - "POST /anthropic/v1/messages?beta=true HTTP/1.1" 500 Internal Server Error
ERROR:    Exception in ASGI application
Traceback (most recent call last):
  File "/Users/cyyeh/Desktop/duckdb-data-agent/backend/.venv/lib/python3.12/site-packages/httpx/_transports/default.py", line 101, in map_httpcore_exceptions
    yield
  File "/Users/cyyeh/Desktop/duckdb-data-agent/backend/.venv/lib/python3.12/site-packages/httpx/_transports/default.py", line 3...
...
1. The conversation started with security questions about API keys and environment variables when hosting a server with Claude Agent SDK.

2. The user asked about hosting a server running Claude agent SDK that invokes Claude Code, and how to prevent API...

### Prompt 26

still see this: Error: API Error: 400 {"type":"error","error":{"type":"invalid_request_error","message":"context_management: Extra inputs are not permitted"},"request_id":"req_011CYM5rBj9vhRVPfK5XV4he"}
...
refine readme to introduce the new functionality: credential proxy
