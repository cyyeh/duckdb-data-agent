...
create a new branch first and write design doc first:

I would like to have automated browser end-to-end test using playwright, that I only need to give a file that states different scenario input and expected output, then you(claude code) could read this file and automatically test it and give me summary report
...
create a new worktree and use subagent
