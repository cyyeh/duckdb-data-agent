...
while the conversation is going(agent is still running) after I swith to other conversation history tab then switch back, the conversation breaks(I don't see any ui)
