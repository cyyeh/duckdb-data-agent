...
new feature alert, write design doc first:

add an export button to the right of clear chat history button to download the full webpage as static html so user could share with others to view full conversation history with agent
...
update readme for this functionality in general section

### Prompt 9

yes, commit all and generate new branch and push and raise pr and merge
