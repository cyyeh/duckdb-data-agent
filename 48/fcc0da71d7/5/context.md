...
what worktree are you in

### Prompt 2

go to worktree chart-library-switch  to implement a functionality to enable user to switch plotting library: vega-lite or plotly
put switch to the left of export button

default: plotly,
for vega-lite, still agent emits json for frontend to render in ui
please write design doc first
